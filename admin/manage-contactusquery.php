...
$query -> execute();
$msg="Query users deleted successfully!";
...
{
	?><td>Read 
	<a href="manage-contactusquery.php?del=<?php echo $result->id;?>" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
