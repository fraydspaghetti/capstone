...
<head>
  ...
  <title>SakayLLC | Contact Us</title>
  <!--Bootstrap -->
  ...
  <section class="contact_us section-padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h3>Reach us through our Social Medias</h3>
          <div class="contact_detail">
            <div class="social-follow">

              <ul>
                <li><a href="https://www.facebook.com/FraydSpaghetti"><i class="fa fa-facebook-square"></i></a></li>
                <li><a href="https://www.instagram.com/tago_kirl/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
              </ul>
            </div>
            <?php
            $pagetype = $_GET['type'];
